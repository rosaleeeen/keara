...
export default function DomeGallery({
  ...
  const clearFocusedTile = useCallback(() => {
    const focusedTile = focusedElRef.current?.parentElement;

    if (focusedTile) {
      focusedTile.classList.remove('item--focused');
    }

    focusedElRef.current?.removeAttribute('data-focused');
  }, []);
  ...
  }, [clearFocusedTile, enlargeTransitionMs, unlockScroll]);
  ...
  const openItemFromElement = useCallback(
    el => {
      ...
      parent.classList.add('item--focused');
      ...
      const rawAlt = el.querySelector('img')?.alt || '';
    ...
    [clearFocusedTile, enlargeTransitionMs, lockScroll, openedImageHeight, openedImageWidth, segments, unlockScroll]
  );
